...
const AnimeCard: React.FunctionComponent<Anime> = ({ slug, poster, canonicalTitle }) => {
  return (
    <div className='w-full mx-auto px-2' style={{ width: 250, height: 340 }}>
      <div
        className='my-3 bg-gradient-to-br from-blue-800 to-blue-600 shadow hover:shadow-lg cursor-pointer transform hover:scale-110 transition border rounded-b rounded-lg'>
